...
if st.button('Predict'):
    ...
    if prediction < 5:
        st.markdown(f'<div style="background-color:#00CC96; padding: 8px; border-radius: 5px;"><b>Predicted E. coli reduction:</b> <span style="color: red;">{prediction:.3f}</span> log</div>', unsafe_allow_html=True)
    else:
